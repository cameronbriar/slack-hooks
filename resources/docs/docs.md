...
* Add the connection parameters in the `reviewninja-slack.db.core` namespace.
...
Request middleware functions are located under the `reviewninja-slack.middleware` namespace.
